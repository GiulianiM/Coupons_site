...
@section('content')
    <div class="container">
        ...
        <div class="border rounded shadow box-content my-5">
            ...
            <div class="right">
                <div class="input-group">
                    <input class="form-control searchInput-utenti" type="search" placeholder="Cerca..."
                           aria-label="Search">
        ...
        <div class="border rounded shadow box-content my-5">
            ...
            <div class="right">
                <div class="input-group">
                    <input class="form-control searchInput-promozioni" type="search" placeholder="Cerca..."
                           aria-label="Search">
