            ...
            <li>
                ...
                <ul>
                    @foreach ($topCategories as $category)
                        <li>
                            <a href="{{ route('catalog2', [$category->catId]) }}">{{ $category->name }}</a><span>{{ $category->desc }}</span>
                        </li>
                    @endforeach
                </ul>
            </li>
                ...
                <li>
                    ...
                    <ul>
                        @foreach ($subCategories as $subCategory)
                            <li>
                                <a href="{{ route('catalog3', [$selectedTopCat->catId, $subCategory->catId]) }}">{{ $subCategory->name }}</a><span>{{ $subCategory->desc }}</span>
                            </li>
                        @endforeach
                    </ul>
                </li>
